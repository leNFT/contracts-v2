...
describe("TradingPoolHelpers", function () {
  ...
  it("Should get the right buy quote", async function () {
    ...
    const minttestERC721Tx1 = await testERC721.mint(owner.address);
    await minttestERC721Tx1.wait();
    const minttestERC721Tx2 = await testERC721.mint(owner.address);
    await minttestERC721Tx2.wait();
