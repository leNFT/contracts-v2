...
describe("LendingMarket", function () {
  ...
  it("Should create a new lending pool", async function () {
    ...
    expect(
      await lendingMarket.getLendingPool(testERC721.address, wethAddress)
  ...
  it("Should borrow an asset from a lending pool using an NFT as collateral", async function () {
    ...
    expect(await testERC721.ownerOf(0)).to.equal(lendingMarket.address);
    ...
    expect(loan.nftAsset).to.equal(testERC721.address);
