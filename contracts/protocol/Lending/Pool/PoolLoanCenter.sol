...
contract PoolLoanCenter is ILoanCenter, OwnableUpgradeable {
    ...
    /// @param asset The address of the NFT contract
    /// @param collateralType The type of collateral (ERC721 or ERC1155)
    /// @param tokenIds An array of NFT token IDs that will be used as collateral
    /// @param tokenAmounts An array of amounts of NFT tokens that will be used as collateral (in case of ERC1155)
    ...
    function createLoan(
        ...
        uint256 amount,
        address asset,
        DataTypes.TokenStandard collateralType,
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            _nftToLoanId[asset][tokenIds[i]] = _loansCount;
        }
