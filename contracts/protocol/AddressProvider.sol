...
contract AddressProvider is OwnableUpgradeable, IAddressProvider {
    ...
    function setLiquidityPair721Metadata(
        ...
        _liquidityPair721Metadata = liquidityPairMetadata;
    }

    function getLiquidityPair721Metadata()
        external
        view
        override
        returns (address)
    ...
    function setLiquidityPair1155Metadata(
        ...
        _liquidityPair1155Metadata = liquidityPairMetadata;
    }

    function getLiquidityPair1155Metadata()
        external
        view
        override
        returns (address)
    ...
    function setTradingPoolRegistry(
        address tradingPoolRegistry
    ) external override onlyOwner {
        _tradingPoolRegistry = tradingPoolRegistry;
    }

    function getTradingPoolRegistry() external view override returns (address) {
        return _tradingPoolRegistry;
    }

    function setSwapPoolFactory(address swapPoolFactory) external override {
        _swapPoolFactory = swapPoolFactory;
    }

    function getSwapPoolFactory() external view override returns (address) {
        return _swapPoolFactory;
    }
